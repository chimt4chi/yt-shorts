  ...
  return (
    <>
      <div className="hidden w-[15%] sm:flex flex-col mt-8">
        <div className="flex gap-7 ml-2 mb-5 hover:bg-[#212121] cursor-pointer h-[40px] items-center rounded-md ">
          <div className="ml-7 flex gap-7">
            <AiOutlineHome size={24} />
            <span className="hidden lg:flex">Home</span>
          </div>
        </div>
        <div className="flex gap-7 ml-2 mb-5 hover:bg-[#212121] cursor-pointer h-[35px] items-center rounded-md">
          <div className="ml-7 flex gap-7">
